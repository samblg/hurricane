...
class Module(modules.module.Module):
    ...
    def __init__(self):
        ...
        self.defaultConf['as'] = 'nasm'
        self.defaultConf['cflags'] = ''
        self.defaultConf['cxxflags'] = ''
        self.defaultConf['asflags'] = ''
    ...
    def make(self, projectConfig):
        makeConf = {
            ...
            'as': projectConfig.getItem('make.configuration.compiler.asm.as', self.defaultConf['as']),
            ...
            'asflags': projectConfig.getItem('make.configuration.compiler.asm.flags', self.defaultConf['asflags']),
            ...
            'asm_src_exts': projectConfig.getItem('make.configuration.compiler.asm.src_exts', self.defaultConf['asm_src_exts']),
            ...
            'asm_include_paths': projectConfig.getItem('make.configuration.compiler.asm.include_paths', self.defaultConf['asm_include_paths']),
            'asm_with_object_ext': projectConfig.getItem('make.configuration.compiler.asm.with_object_ext', self.defaultConf['asm_with_object_ext']),
        }
        ...
        FileUtil.searchAllFiles(asmSourceFiles, SRC_MAIN_PATH, makeConf['asm_src_exts'])

        self.mainSourceFiles.extend(cSourceFiles)
        self.mainSourceFiles.extend(cppSourceFiles)
        self.mainSourceFiles.extend(asmSourceFiles)
