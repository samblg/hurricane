...
void Manager::ReserveExecutors()
{
    ...
    hurricane::base::NetAddress presidentAddress(
...
hurricane::message::CommandClient* Manager::CreatePresidentClient()
{
    hurricane::base::NetAddress presidentAddress(_managerConfiguration->GetProperty(CONF_KEY_PRESIDENT_PORT),
                                                 _managerConfiguration->GetIntegerProperty(CONF_KEY_PRESIDENT_PORT));
    hurricane::util::NetConnector* presidentConnector =
            new hurricane::util::NetConnector(presidentAddress);
    hurricane::message::CommandClient* presidentClient =
            new hurricane::message::CommandClient(presidentConnector);
